...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'user.activo'])->group(function () {
        ...
        Route::middleware('oportunidades-ver')->group(function () {
            ...
            Route::get('oportunidades/para-cotizar/{codigo}/asignar', [OportunidadParaCotizarController::class, 'asignarForm'])
                ->name('oportunidades.para-cotizar.asignar')
                ->where('codigo', '[^/]+');
            Route::post('oportunidades/para-cotizar/{codigo}/asignar', [OportunidadParaCotizarController::class, 'asignar'])
                ->name('oportunidades.para-cotizar.asignar.store')
                ->where('codigo', '[^/]+');
        ...
        Route::middleware('superadmin')->group(function () {
            ...
            Route::middleware('compra-agil-analisis')->group(function () {
                ...
                Route::get('compra-agil/analisis/producto/{prodItem}/nota', [CompraAgilAnalisisController::class, 'detalleNotaProducto'])->name('compra-agil.analisis.nota')->where('prodItem', '[^/]+');
