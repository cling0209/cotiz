...
@section('title', 'Segundo llamado — Resultados Compra Ágil')
...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h1 class="h3 mb-0">Segundo llamado</h1>
        <span class="badge text-bg-info">{{ $items->total() }}</span>
    </div>

    <p class="text-muted small mb-3">
        Cotizaciones con seguimiento «Pendiente», estado MP «Publicada» y convocatoria «Segundo llamado»
        (listas para postular). Use «Consultar MP» para actualizar el estado en Mercado Público.
    </p>
    ...
    <form method="GET" action="{{ route('admin.compra-agil.resultados.segundo-llamado') }}" class="card shadow-sm mb-3" data-no-loader>
            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-auto">
                    ...
                    @if(collect($filtros)->except(['sort', 'dir'])->filter()->isNotEmpty())
                        <a href="{{ route('admin.compra-agil.resultados.segundo-llamado', request()->only(['sort', 'dir'])) }}" class="btn btn-outline-secondary btn-sm ms-1" data-no-loader>
    ...
    <div class="card shadow-sm">
        <div class="card-header py-2 d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            @if($items->total() > 0)
                <a href="{{ route('admin.compra-agil.resultados.segundo-llamado.exportar', request()->query()) }}" class="btn btn-outline-success btn-sm" download data-no-loader>
        ...
        <div class="table-responsive">
            <table class="table table-sm table-hover align-middle mb-0">
                <thead class="table-info">
                    <tr>
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'nronota', 'label' => 'Nota', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'codigo_proceso', 'label' => 'Código CA', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_publicacion', 'label' => 'Publicación', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_ultimo_cambio', 'label' => 'Último cambio', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_cierre_primer_llamado', 'label' => 'Cierre 1er llamado', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_cierre_segundo_llamado', 'label' => 'Cierre 2do llamado', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'convocatoria', 'label' => 'Estado convocatoria', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'ejecutivo', 'label' => 'Ejecutivo', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'organismo', 'label' => 'Organismo', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'estado_mp', 'label' => 'Estado MP', 'route' => 'admin.compra-agil.resultados.segundo-llamado'])
