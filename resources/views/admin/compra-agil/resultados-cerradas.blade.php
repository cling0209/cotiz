            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-auto">
                    ...
                    @if(collect($filtros)->except(['sort', 'dir'])->filter()->isNotEmpty())
                        <a href="{{ route('admin.compra-agil.resultados.cerradas', request()->only(['sort', 'dir'])) }}" class="btn btn-outline-secondary btn-sm ms-1" data-no-loader>
        ...
        <div class="table-responsive">
            <table class="table table-sm table-hover align-middle mb-0">
                <thead class="table-dark">
                    <tr>
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'nronota', 'label' => 'Nota', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'codigo_proceso', 'label' => 'Código CA', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_publicacion', 'label' => 'Publicación', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_ultimo_cambio', 'label' => 'Último cambio', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_cierre_primer_llamado', 'label' => 'Cierre 1er llamado', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'fecha_cierre_segundo_llamado', 'label' => 'Cierre 2do llamado', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'convocatoria', 'label' => 'Estado convocatoria', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'ejecutivo', 'label' => 'Ejecutivo', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'organismo', 'label' => 'Organismo', 'route' => 'admin.compra-agil.resultados.cerradas'])
                        @include('admin.compra-agil.partials.th-sortable', ['col' => 'estado_mp', 'label' => 'Estado MP', 'route' => 'admin.compra-agil.resultados.cerradas'])
