...
return new class extends Migration
{
    ...
    {
        Schema::create('producto_mp_busqueda_corridas', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('matches_encontrados')->default(0);
            $table->unsignedInteger('cas_revisadas')->default(0);
    ...
    {
        Schema::dropIfExists('producto_mp_busqueda_corridas');
    }
};
